...
public class CourseTrainActivity extends Activity implements OnClickListener{
	...
	private void initData() {
		...
		courseTrainInfo1.strTrainDecript = "背部 胸部";
		...
		courseTrainInfo2.strTrainDecript = "背部 胸部";
		...
		courseTrainInfo3.strTrainDecript = "背部 胸部";
		...
		courseTrainInfo4.strActionNum = "动作一";
		courseTrainInfo4.strTrainDecript = "背部 胸部";
