...
public class CircleMaskImageView extends ImageView {
    ...
    public CircleMaskImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setProgress(float progress){
        ...
        float revertProgress = -(1-progress);
        mSweepAngle = revertProgress * 360;
        invalidate();
    }
...
//        canvas.drawCircle(getWidth() / 2, getHeight() / 2, mDrawableRadius, mBitmapPaint);
        ...
        canvas.drawArc(mBorderRect, -90, mSweepAngle, true, mBitmapPaint);
    ...
    private void setup() {
        ...
        // mBorderRadius = Math.min((mBorderRect.height() - mBorderWidth) / 2, (mBorderRect.width() - mBorderWidth) /
        // 2);
